...
\* Last modified Wed Dec 13 23:22:02 GMT 2023 by samue
...
\* BEGIN TRANSLATION (chksum(pcal) = "c5e3d98a" /\ chksum(tla) = "21ee538d")
...
WriterWrite(self) == /\ pc[self] = "WriterWrite"
                     /\ IF threads[1].full = FALSE
                           THEN /\ sent' = [sent EXCEPT ![(1 + ((threads[1].endr + 1) % size))] =                                              [
                                                                                                      Reader |-> "not-read",
                                                                                                      Writer |-> "written"
                                                                                                  ]]
